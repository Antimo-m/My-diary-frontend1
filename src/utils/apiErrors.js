const errorTranslations = {
  it: [
    ...
    [/failed to upload|non e stato possibile caricare/i, 'Non è stato possibile caricare l’immagine. Verifica che non superi 4 MB e riprova.'],
    [/may not be greater than 4096 kilobytes|non puo superare 4096 kilobyte/i, 'L’immagine non può superare 4 MB.'],
  ...
  en: [
    ...
    [/failed to upload|non e stato possibile caricare/i, 'The image could not be uploaded. Make sure it is no larger than 4 MB and try again.'],
    [/may not be greater than 4096 kilobytes|non puo superare 4096 kilobyte/i, 'The image cannot exceed 4 MB.'],
